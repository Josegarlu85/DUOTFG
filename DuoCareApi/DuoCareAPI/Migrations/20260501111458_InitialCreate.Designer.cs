...
namespace DuoCareAPI.Migrations
{
    ...
    [Migration("20260501111458_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DuoCareAPI.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DuoCareAPI.Models.Record", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DuoCareAPI.Models.User", b =>
                {
            ...
            modelBuilder.Entity("DuoCareAPI.Models.Appointment", b =>
                {
                    b.HasOne("DuoCareAPI.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DuoCareAPI.Models.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("DuoCareAPI.Models.Record", b =>
                {
                    b.HasOne("DuoCareAPI.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DuoCareAPI.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
